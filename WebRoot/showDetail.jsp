...
<% if(loginBean==null){
   ...
   try{ 
     con=DriverManager.getConnection(uri,"root","sll");
     ...
     while(rs.next()){
       ...
       "("+number+","+name+","+maker+
        ...
        String button="<form  action='putGoodsServlet' method = 'post'>"+
                     ...
                     "<input type ='submit'  value='放入购物车' class='btn btn-sm btn-success' ></form>";
        out.print("<tr>");
     ...
     String pic ="<img src='image/"+picture+"' width=460 height=400 ></img>";
     out.print(pic); //产片图片
     con.close();                 
  }
